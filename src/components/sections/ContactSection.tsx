import { Phone, Mail, MapPin, Clock, Instagram, Facebook, Linkedin, Twitter, MessageSquare, ChevronDown, MoveRight, Navigation, Sparkles, Zap, Shield, Globe } from 'lucide-react'
import ContactForm from '@/components/ui/ContactForm'
import { motion, useScroll, useTransform } from 'framer-motion'
import { useState, useRef, useEffect } from 'react'
import { regions, companyStats } from '@/data/company'
...
const ContactSection = () => {
  ...
  return (
    <motion.section
      ref={sectionRef}
      id="contact"
      className="relative min-h-screen pb-0 overflow-hidden"
      style={{ y, opacity }}
    >
      {/* Dynamic Background */}
