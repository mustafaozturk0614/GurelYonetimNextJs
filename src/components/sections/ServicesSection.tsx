        ...
        <div className={`text-center mt-16 transform transition-all duration-1000 delay-1000 ${
          ...
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-3xl p-8 text-white shadow-2xl">
            ...
            <p className="text-lg opacity-90 max-w-2xl mx-auto leading-relaxed">
              {`Yönetimdeki ${companyStats.find(stat => stat.label === 'Yıl Deneyim')?.number || 'Tecrübeli'} deneyimimiz, ${companyStats.find(stat => stat.label === 'Memnun Müşteri')?.number || 'Çok sayıda'} memnun müşterimiz ve ${companyStats.find(stat => stat.label === 'Destek Hizmeti')?.number || '7/24'} kesintisiz hizmet anlayışımızla`}
